...
export function ZhScenarioConstructor({
  ...
  return (
    <div style={{ padding: '1rem 1.25rem', overflowY: 'auto', flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column', gap: '0.85rem' }}>
      ...
      <div>
        ...
        {(draft.vocabulary || []).map((v, i) => (
          <div key={`v-${i}`} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr auto', gap: 6, marginBottom: 6 }}>
