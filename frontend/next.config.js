...
const nextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_YANDEX_CLIENT_ID: process.env.NEXT_PUBLIC_YANDEX_CLIENT_ID || '78b55a850b524bcfb4899f22062fa7b2',
    NEXT_PUBLIC_YANDEX_REDIRECT_URI: process.env.NEXT_PUBLIC_YANDEX_REDIRECT_URI || 'https://speakeasy-voice.vercel.app/auth/yandex/callback',
  },
}
