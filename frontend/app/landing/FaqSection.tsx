...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: 'Английский и китайский. Для английского — сценарии, дебаты и словарь с идиомами и фразовыми глаголами. Для китайского — ситуативные диалоги HSK, голосовые минутки, словарь 词语/汉字 с пиньинем. Язык обучения выбирается в аккаунте. Переключатель English / 中文 на этой странице только показывает, как выглядит каждый режим.',
  },
  {
    id: 'how-start',
  ...
  const items = [
    {
      ...
      question: 'Что такое Speakeasy?',
      answer: isZh
        ? 'Это платформа для практики китайского: свободный разговор и ситуативный диалог HSK с ИИ, голосовые минутки, словарь 词语/汉字 с пиньинем и прогресс по китайским критериям. Английский тоже есть — переключи превью наверху.'
    ...
    },
    {
      ...
      question: 'Какие языки можно учить?',
      answer: isZh
        ? 'Сейчас превью китайского: свободный разговор, ситуативный диалог HSK, голосовые минутки и словарь 词语/汉字. Караоке, дебаты и фразовые глаголы в китайском треке нет — они только в английском. Язык обучения выбирается в аккаунте.'
        : 'Сейчас превью английского: сценарии, дебаты, караоке по YouTube и словарь с идиомами и фразовыми глаголами. Китайский — отдельные диалоги HSK и голосовые минутки, без караоке. Язык обучения в аккаунте. Переключатель English / 中文 только показывает каждый режим.',
    },
    {
      id: 'how-start',
      question: 'Как начать заниматься?',
      answer: isZh
        ? 'Зарегистрируйся, пополни баланс (от 300 ₽) — подписки нет. Дальше выбирай китайский в аккаунте: свободный разговор, ситуативный диалог HSK, голосовые минутки, словарь, аналитика. Баланс один на все разделы.'
        : FAQ_ITEMS[2].answer,
    },
    FAQ_ITEMS[3],
    FAQ_ITEMS[4],
