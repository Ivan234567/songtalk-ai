  ...
  zh: [
    {
      ...
      via: ['Собеседник'],
      viaText: 'Свободный разговор и ситуативный диалог HSK — практикуй в своём темпе.',
    },
    {
      before: 'Учу слова к HSK, но они вылетают из головы.',
      after: '词语 и 汉字 с пиньинем лежат в словаре и всплывают в речи.',
      via: ['Словарь'],
      viaText: 'Пиньинь, тоны, озвучка и повторение в одном словаре.',
    },
    {
      before: 'Учу HSK вроде бы, но расту ли — непонятно.',
      after: 'Баллы сценариев и минуток показывают, где я вырос.',
      via: ['Аналитика'],
      viaText: 'Критерии китайской оценки, разбор сценариев и минуток, рекомендации.',
    },
  ],
} as const;
