...
const TESTIMONIALS = {
  ...
  zh: [
    ...
    {
      quote: 'Голосовые минутки короткие, но по делу. После недели проще заказать еду вслух.',
      name: 'Кирилл',
      role: 'учит китайский',
    },
    {
      quote: '词语 сохраняю с пиньинем из сценариев. Больше не зубрю список — вспоминаю, когда говорю.',
      name: 'Лена',
      role: 'учит китайский к HSK',
    },
  ],
} as const;
